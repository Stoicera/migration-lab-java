...
| `stage-4-boot-4x` | Boot 2.7 → 3.5 → 4.1 + Java 25; OpenRewrite used AND evaluated ([ADR-0002](docs/adr/0002-openrewrite-as-assistant-not-autopilot.md)); constructor-injection sweep; SQL-injection (B4) closed with before/after proof | [Kap. 4 — Boot 3/4, Java 25 & OpenRewrite](playbook/04-boot-3-4-java-25-und-openrewrite.md) | **done** (2026-07-30) |

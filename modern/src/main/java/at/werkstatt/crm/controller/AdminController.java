...
/**
 * Stage 5 (SD-2, ADR-0004): the JSP admin page is absorbed into the SPA — this
 * controller now serves JSON for the Angular /admin route (gson and the whole
 * JSP/JSTL stack died with the page). POST /admin/bereinigen keeps its path
 * and its exact German meldung: that contract is pinned by the
 * characterization suite on both stands.
 */
@RestController

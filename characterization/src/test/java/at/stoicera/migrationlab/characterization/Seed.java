...
/**
 * Expectations that depend on the committed seed (legacy/db/init/02-daten.sql) AND on the wall
 * clock.
 *
 * <p>Calendar coupling: the application builds Auftrag/Rechnung numbers from the CURRENT year
 * (Calendar.getInstance().get(YEAR)) and MAX+1 within that year. The seed contains orders
 * A-2026-0001..0016 and invoices R-2026-0001..0008 — all dated 2026, none in any other year. So
 * while the suite runs in 2026 the next numbers are A-2026-0017 / R-2026-0009; in any later year
 * the MAX+1 scan finds nothing and the numbering restarts at A-&lt;year&gt;-0001 /
 * R-&lt;year&gt;-0001. Computing the expectation here (instead of hard-coding 2026 values) keeps
 * the suite green after New Year without touching a test.
 */
final class Seed {

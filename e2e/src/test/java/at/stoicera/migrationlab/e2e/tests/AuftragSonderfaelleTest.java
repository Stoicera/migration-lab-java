...
/**
 * Scenario: the order flows besides the happy path — cancellation, the FERTIG→IN_ARBEIT special
 * case ("doch noch was gefunden"), and position editing with the net sum recalculating. All on seed
 * orders.
 */

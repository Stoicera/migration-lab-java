...
/**
 * Scenario: the Monday-morning glance — the start page must show the exact
 * workshop state of the seed. KPI derivation from the seed:
 * offene = ANGENOMMEN (0014, 0015) + IN_ARBEIT (0011, 0013) = 4;
 * fertig = FERTIG (0009, 0012) = 2; unbezahlt = R-2026-0005 = 1.
 */
...
class DashboardTest extends ScenarioTest {
	...
	void werkstattUndAbholbereitListen() {
		...
		assertThat(werkstatt.get(0)).containsExactly("A-2026-0015", "PE-123AB", "Hofer Franz", "Angenommen");
		assertThat(werkstatt.get(2)).containsExactly("A-2026-0013", "L-246WX", "Brunner Elisabeth", "In Arbeit");
		...
		assertThat(abholbereit.get(0)).containsExactly("A-2026-0012", "PE-655QS", "Huber Transporte GmbH", "08.07.2026");
		assertThat(abholbereit.get(1)).containsExactly("A-2026-0009", "PE-987ST", "Wagner Christine", "20.05.2026");
	}
}

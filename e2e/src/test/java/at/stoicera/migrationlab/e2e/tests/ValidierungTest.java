...
/**
 * Scenario: what the legacy UI actually does when required input is missing — a bare JS alert from
 * the controller, no request sent, form state kept. The alert TEXTS are pinned exactly: they are
 * part of the observed behavior the stage-5 UI must either reproduce or change via ADR-0004.
 */

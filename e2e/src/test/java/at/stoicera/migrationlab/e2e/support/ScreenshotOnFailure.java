...
/**
 * Every failure leaves a screenshot in target/screenshots — flaky analysis starts with evidence,
 * not with re-running and hoping.
 */
public class ScreenshotOnFailure implements TestWatcher {
  ...
  public void testFailed(ExtensionContext context, Throwable cause) {
    context
        ...
        .ifPresent(
            instance -> {
              if (instance instanceof E2eTestBase base
                  && base.driver() instanceof TakesScreenshot shooter) {
                try {
